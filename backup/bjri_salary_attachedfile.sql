...
CREATE TABLE `attachedfile` (
  ...
  `DocumentPath` text,
  PRIMARY KEY (`Id`),
  KEY `IX_AttachedFile_LeaveId` (`LeaveId`),
  CONSTRAINT `FK_AttachedFile_LeaveApplications_LeaveId` FOREIGN KEY (`LeaveId`) REFERENCES `leaveapplications` (`Id`) ON DELETE CASCADE
...
INSERT INTO `attachedfile` VALUES (1,236,'9f5131c7-43bf-45d4-8c6e-68394a535ac7_G0.pdf');
