...
--
-- Dumping data for table `leavehistories`
--

LOCK TABLES `leavehistories` WRITE;
/*!40000 ALTER TABLE `leavehistories` DISABLE KEYS */;
/*!40000 ALTER TABLE `leavehistories` ENABLE KEYS */;
UNLOCK TABLES;
